...
export const colorsBgLight: ColorType = {
...
export const colorsText: ColorType = {
...
export const colorsOutline: ColorsType = {
  white: [colorsText.white as string, 'border-gray-100'],
  light: [colorsText.light as string, 'border-gray-100'],
...
export const getButtonColor = (
  ...
  const base = [colors.borders[color], colors.ring[color]] as string[];

  if (isActive) {
    base.push(colors.active[color] as string);
  } else {
    base.push(
      (isOutlinedProcessed ? colors.text[color] : colors.bg[color]) as string,
    );
  }
  ...
  if (hasHover) {
    base.push(
      (isOutlinedProcessed
        ...
        : colors.bgHover[color]) as string,
    );
  }
